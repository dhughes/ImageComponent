...
<cffunction name="generateKey" access="public" output="true" returntype="string">
	<cfargument name="appText" required="true" type="string" />
	<cfset var i = 0 />
...
<cffunction name="validateKey" access="public" output="true" returntype="boolean">
...
<cfset myKey = generateKey("ImageComponent@l794o1WhatIsTheMeaningOfLifeTheUniverseAndEverthing?42.") />

<cfoutput>
	<p>#myKey#</p>
</cfoutput>

<cfdump var="#validateKey(myKey, "ImageComponent@l794o1WhatIsTheMeaningOfLifeTheUniverseAndEverthing?42.")#">
