...
<cfif flash_CUR_PHOTO IS NOT 'no photo'>
    <cfif FileExists("g:\sites\gaggleputz\members\images\#flash_CUR_PHOTO#")>
         <cffile   action = "delete"  file = "e:\sites\gaggleputz\members\images\#flash_CUR_PHOTO#">
    </cfif>
</cfif>
<!---<cfargument name = "flash_GROUP_DIRECTORY" type="any" required="true" default="0">--->
   ...
   <cfset thisPhoto.readImage("e:\sites\gaggleputz\members\images\#flash_OLD_PHOTO_NAME#")/>
   ...
   <cfset thisPhoto.writeImage("e:\sites\gaggleputz\members\images\#flash_NEW_PHOTO_NAME#", "jpg", 80)/>
