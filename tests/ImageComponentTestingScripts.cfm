...
<table width="100%" cellpadding="3" cellspacing="0" border="1">
	...
	<cftry>
		...
		<cfset myImage.readImageFromURL("http://www.alagad.com/uploadImages/image002.jpg") />
	...
	<cftry>
		...
		<cfset fontArray = myImage.getSystemFonts(myString2, "condensed", 0, 10) />
	...
	<cftry>
		...
		<cfset myFont = myImage.loadTTFFile(ExpandPath(request.ttfFile), 40, "Italic") />
